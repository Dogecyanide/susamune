...
- **One theme folder:** background.png and bgm.mp3 now belong in **/Moonshine_Theme** at the root of the launcher's device. The old theme folder beside boot.dol is no longer used.
- **Japanese menus:** JP now has translated launcher and game menus, including the runner's wording corrections. Some changing status messages and diagnostics remain English; the launcher's built-in guide is also English. A separate Japanese download includes the flag background.
