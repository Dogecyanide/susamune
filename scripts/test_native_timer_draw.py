...
struct Extras {CreationStyle style;bool preview,colors,label;unsigned target;u8 rgb[3];
 ...
 bool timerLabelVisible(){return label;} const u8*nativeTimerRgb(J2DPane*){return colors?rgb:0;}
} gCreationExtras;
